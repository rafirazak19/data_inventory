    ...
    public function store(StoreCommodityRequest $request)
{
    ...
    // Generate QR Code content (e.g., commodity ID or custom code)
    $qrContent = 'barang-' . uniqid();
    ...
    // Optional: simpan QR image jika ingin sebagai file
    \Storage::put("public/qrcodes/{$qrContent}.svg", QrCode::format('svg')->size(300)->generate($qrContent));

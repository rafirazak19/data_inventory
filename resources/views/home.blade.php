<x-layout>
	...
	<div class="row">
		<div class="col-md-6 col-lg-8">
			<div class="card">
				<x-bar-chart chartTitle="Grafik Barang Jumlah Barang" chartID="chartCommodityCondition"
	...
	<div class="row">
		<div class="col-lg-7">
			<x-bar-chart chartTitle="Grafik Jumlah Barang Masuk" chartID="chartCommodityCountEachYear"

		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						<h5 class="text-dark font-weight-normal pt-5 mt-5">Aplikasi <span class="font-weight-bold">Inventory Barang Shuttshoot
								</span></h5>
				...
				<div
					...
					data-background="../assets/img/unsplash/ssout.jpg">
